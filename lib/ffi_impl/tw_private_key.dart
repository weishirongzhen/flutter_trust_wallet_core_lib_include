...
abstract class TWPrivateKey {
  ...
  static late final _TWPrivateKeyGetPublicKeySecp256k1Extended_ptr =
      _lookup<NativeFunction<_c_TWPrivateKeyGetPublicKeySecp256k1Extended>>(
          'TWPrivateKeyGetPublicKeySecp256k1Extended');
  static late final _dart_TWPrivateKeyGetPublicKeySecp256k1Extended
      _TWPrivateKeyGetPublicKeySecp256k1Extended =
      _TWPrivateKeyGetPublicKeySecp256k1Extended_ptr.asFunction<
          _dart_TWPrivateKeyGetPublicKeySecp256k1Extended>();

  /// Returns the public key associated with this private key.
  static Pointer<Void> TWPrivateKeyGetPublicKeySecp256k1Extended(
    Pointer<Void> pk,
  ) {
    return _TWPrivateKeyGetPublicKeySecp256k1Extended(
      pk,
    );
  }

  static late final _TWPrivateKeyGetPublicKeyNist256p1Extended_ptr =
      _lookup<NativeFunction<_c_TWPrivateKeyGetPublicKeyNist256p1Extended>>(
          'TWPrivateKeyGetPublicKeyNist256p1Extended');
  static late final _dart_TWPrivateKeyGetPublicKeyNist256p1Extended
      _TWPrivateKeyGetPublicKeyNist256p1Extended =
      _TWPrivateKeyGetPublicKeyNist256p1Extended_ptr.asFunction<
          _dart_TWPrivateKeyGetPublicKeyNist256p1Extended>();

  /// Returns the public key associated with this private key.
  static Pointer<Void> TWPrivateKeyGetPublicKeyNist256p1Extended(
    Pointer<Void> pk,
  ) {
    return _TWPrivateKeyGetPublicKeyNist256p1Extended(
      pk,
    );
  }
...
typedef _c_TWPrivateKeyGetPublicKeySecp256k1Extended = Pointer<Void> Function(
  Pointer<Void> pk,
);

typedef _dart_TWPrivateKeyGetPublicKeySecp256k1Extended = Pointer<Void>
    Function(
  Pointer<Void> pk,
);
...
typedef _c_TWPrivateKeyGetPublicKeyNist256p1Extended = Pointer<Void> Function(
  Pointer<Void> pk,
);

typedef _dart_TWPrivateKeyGetPublicKeyNist256p1Extended = Pointer<Void>
    Function(
  Pointer<Void> pk,
);
